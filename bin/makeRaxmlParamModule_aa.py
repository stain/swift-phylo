...
def paramModuleRaxml(dirin, phy, model, bootstrap, nb_categ):
  ...
  for f in os.listdir(dirin):
    if f.endswith('.phylip'):                                                    
      ...
      cmd_raxml_s = "raxmlHPC -s " + phylip + " -n " + phylip + "_raxml_tree1.singleTree -c " + nbc + " -f d -m " + model + " -p 1"
      ...
      cmd_raxml_b = "raxmlHPC -s " + phylip + " -n " + phylip + "_tree2.raxml -c " + nbc + " -f d -m " + model + " -b 234534251 -N " + btp + " -p 1"
      ...
      cmd_raxml_c = "raxmlHPC -f b -m " + model + " -c " + nbc + " -s " + phylip + " -z " + "RAxML_bootstrap." + phylip + "_tree2.raxml -t RAxML_bestTree." + phylip + "_raxml_tree1.singleTree -n " + phylip + "_tree3.BS_TREE -p 1"
